#!/usr/bin/env python
"""
Test grid generation and evaluation with tricubic interpolation.
Tricubic interpolation requires derivatives to be computed during grid generation.
"""
...
print("Testing grid energy with tricubic interpolation")
print("=" * 80)
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    print("\n" + "=" * 80)
    print("RESULTS WITH TRICUBIC INTERPOLATION")
    print("=" * 80)
