#!/usr/bin/env python
"""
Test grid generation and evaluation with triquintic interpolation.
Triquintic interpolation requires derivatives to be computed during grid generation
and should provide the highest accuracy of all interpolation methods.
"""
...
print("Testing grid energy with triquintic interpolation")
print("=" * 80)
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    print("\n" + "=" * 80)
    print("RESULTS WITH TRIQUINTIC INTERPOLATION")
    print("=" * 80)
