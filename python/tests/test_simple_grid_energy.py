#!/usr/bin/env python
"""
Simple test to verify grid generation and energy calculation work correctly.
Uses inv_power=0 (NONE mode) for simplicity.
"""
...
print("Testing grid energy with inv_power=0 (NONE mode)")
print("=" * 80)

with tempfile.TemporaryDirectory() as tmpdir:
    # Generate grids WITHOUT inv_power transformation
    print("\nGenerating grids with inv_power=0...")
    for grid_type in ['charge', 'lja', 'ljr']:
        ...
        # Use NONE mode with inv_power=0
    ...
    print("\n" + "=" * 80)
    print("RESULTS WITH INV_POWER=0")
    print("=" * 80)
