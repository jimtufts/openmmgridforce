#ifndef OPENMM_HCTKERNELS_H_
#define OPENMM_HCTKERNELS_H_

/* -------------------------------------------------------------------------- *
 *                              OpenMMGridForce                               *
 * -------------------------------------------------------------------------- *
 * HCT pairwise descreening integral and its r-derivatives, in the plugin's
 * unit and normalization convention: nm, and psi = 0.5 * R_off * hct.
 *
 * Shared by the Reference/CPU kernels and by the receptor field precompute
 * so that grid generation and pairwise evaluation cannot drift apart.
 * -------------------------------------------------------------------------- */
